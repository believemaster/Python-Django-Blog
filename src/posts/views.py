...
def get_category_count():  # for making categories count which are present and then showing them
    query_set = Post.objects.values("category__name").annotate(
        Count("category__name")).order_by('category_id')
    return query_set
...
def post_list(request):
    ...
    # print(category_count)	# shows category count in terminal
